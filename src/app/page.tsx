        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center">
          <div className="max-w-2xl">
            ...
            <div className="flex space-x-4">
              <button className="bg-ps-tan text-black px-6 py-3 rounded-sm font-medium hover:bg-ps-cream transition-colors duration-300">
                Explore Projects
              </button>
              <button className="border border-ps-tan text-ps-tan px-6 py-3 rounded-sm font-medium hover:bg-ps-tan/10 transition-colors duration-300">
                Contact Me
              </button>
            </div>
          </div>
